(() => {
  ...
  function bind(){
    ...
    window.addEventListener('accounts-source-selected',()=>{totalAutoEntered=true;exitTotal();document.getElementById('accountsTotalPanel')?.setAttribute('hidden','')});
    window.addEventListener('accounts-shared-selected',()=>{totalAutoEntered=true;exitTotal();document.getElementById('accountsTotalPanel')?.setAttribute('hidden','')});
