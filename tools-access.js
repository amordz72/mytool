    ...
    if(dashboard&&workerTools&&!$('generalTools')){
      ...
      panel.innerHTML=`
        ...
        <section class="grid">
          ...
          <a class="card" href="programs/#hilink-ip-manager"><div class="icon">📡</div><h2>HiLink IP Manager</h2><p>إدارة مودمات Huawei HiLink وUSB وIPv4 وتنزيل نسخة Windows.</p><span class="badge">أداة عامة</span></a>
