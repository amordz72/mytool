    ...
    if(dashboard&&workerTools&&!$('generalTools')){
      ...
      panel.innerHTML=`
        ...
        <section class="grid">
          ...
          <a class="card" href="https://github.com/amordz72/hilink-ip-manager/actions/runs/36243839020/artifacts/10906732575" target="_blank" rel="noopener"><div class="icon">📡</div><h2>HiLink IP Manager</h2><p>تحميل نسخة Windows الجاهزة مباشرة.</p><span class="badge">تحميل</span></a>
