...
(function(){
  ...
  const routes=[
    ...
    {id:'sale',group:'operations',label:'تسجيل بيع',shortLabel:'بيع',path:'sale.html',type:'worker',roles:['admin','worker'],permission:'sell',placement:['drawer','top'],icon:'＋',daily:true,dailyOrder:10,dailyDesc:'تسجيل بيع سلعة من المخزون'},
    {id:'services',group:'operations',label:'بيع خدمة',shortLabel:'خدمة',path:'services.html',type:'worker',roles:['admin','worker'],permission:'sell',placement:['drawer','top'],icon:'✦'},
    ...
    {id:'customer-master-feed',group:'admin',label:'تغذية ماستر العملاء',shortLabel:'تغذية العملاء',path:'customer-master-feed.html?v=20260923-1',type:'admin',roles:['admin'],placement:['drawer'],icon:'⊕'},
    {id:'card-master-feed',group:'admin',label:'تغذية ماستر البطاقات',shortLabel:'تغذية البطاقات',path:'../cards/master-feed.html?v=20260923-1',type:'admin',roles:['admin'],placement:['drawer'],icon:'▣'},
    {id:'customer-links',group:'admin',label:'صيانة ربط العملاء',shortLabel:'صيانة الربط',path:'customer-links.html?v=20260923-link-semantics2',type:'admin',roles:['admin'],placement:['drawer'],icon:'⇆'},
