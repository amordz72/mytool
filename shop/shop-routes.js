...
(function(){
  ...
  const routes=[
    ...
    {id:'customer-links',group:'admin',label:'ربط ومصادر العملاء',shortLabel:'ربط العملاء',path:'customer-links.html?v=20260923-multi-import-preview1',type:'admin',roles:['admin'],placement:['drawer'],icon:'⇆'},
