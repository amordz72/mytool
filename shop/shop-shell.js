...
(function(){
  ...
  function loadScreenEnhancer(){const screen=document.body?.dataset?.screen||'';const quick='quick-pricing.js?v=20260913-1938';const map={purchase:[quick,'purchase-autofill.js?v=20260913-1700','price-guidance.js?v=20260913-1700','catalog-picker.js?v=20260916-1949'],sale:[quick,'sale-price-sync.js?v=20260913-1700','price-guidance.js?v=20260913-1700','catalog-picker.js?v=20260916-1949'],inventory:[quick,'inventory-pricing.js?v=20260913-1938','catalog-picker.js?v=20260916-1949'],products:['products-pagination.js?v=20260913-1700'],'opening-stock':['opening-stock-policy.js?v=20260913-1700'],'physical-inventory':['physical-inventory-design.js?v=20260916-1']};(map[screen]||[]).forEach((src,index)=>{if(document.querySelector('script[data-shop-enhancer="'+screen+'-'+index+'"]'))return;const script=document.createElement('script');script.src=src;script.defer=true;script.dataset.shopEnhancer=screen+'-'+index;document.head.appendChild(script)})}
